...
export class TargetsService {
  ...
  async create(
    ...
    this.logger.log(
      `Creating target ${dto.type}:${dto.externalId} in workspace=${workspaceId} by user=${user.id}`,
    );
  ...
  async update(
    ...
    this.logger.log(
      `Updating target ${targetId} in workspace=${workspaceId} by user=${user.id}`,
    );
  ...
  async remove(
    ...
    this.logger.log(
      `Deleting target ${targetId} from workspace=${workspaceId} by user=${user.id}`,
    );
